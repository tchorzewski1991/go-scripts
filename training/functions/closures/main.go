...
func main() {
	...
	// the function call, copy of that variable will be stored on new empty
	// memory slot.

	x = 0

	// Variable x won't be successfully incremented as we operate on copy.
	incrementByOne(x)
	fmt.Println("x is: ", x)

	// Variable x will be successfully incremented because of pointers manipulations.
